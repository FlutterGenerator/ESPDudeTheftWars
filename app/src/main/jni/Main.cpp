...
*/
	...
	get_transform = (void *(*)(void *)) getAbsoluteAddress(targetLibName, str2Offset(OBFUSCATE("0x2204BAC")));
	// public class Transform : Component, IEnumerable public Vector3 get_position() { }
	get_position = (Vector3 (*)(void *)) getAbsoluteAddress(targetLibName, str2Offset(OBFUSCATE("0x2214CF8")));
	// public sealed class Camera : Behaviour public static Camera get_main() { }
	get_maincamera = (void *(*)()) getAbsoluteAddress(targetLibName, str2Offset(OBFUSCATE("0x21D7008")));
	// public sealed class Camera : Behaviour public Vector3 WorldToScreenPoint(Vector3 position) { }
	get_worldtoscreenpoint = (Vector3 (*)(void *, Vector3)) getAbsoluteAddress(targetLibName, str2Offset(OBFUSCATE("0x21D6964")));
	// public sealed class Screen public static int get_width() { }
	get_gamewidth = (int (*)()) getAbsoluteAddress(targetLibName, str2Offset(OBFUSCATE("0x21E1784")));
	// public sealed class Screen public static int get_height() { }
	get_gameheight = (int (*)()) getAbsoluteAddress(targetLibName, str2Offset(OBFUSCATE("0x21E17C4")));
	// public sealed class GameObject : Object public Transform get_transform() { }
	get_gameobjecttransform = (void *(*)(void *)) getAbsoluteAddress(targetLibName, str2Offset(OBFUSCATE("0x2207FFC")));
	// public class ManAI : MonoBehaviour private void Update() { }
	HOOK(targetLibName, str2Offset(OBFUSCATE("0xBCA3B0")), npcupdate, old_npcupdate);
	// public class ManAI : MonoBehaviour private void OnDisable() { }
	HOOK(targetLibName, str2Offset(OBFUSCATE("0xBC8F0C")), npcondisable, old_npcondisable);
	// public class ManAI : MonoBehaviour private void OnDestroy() { }
	HOOK(targetLibName, str2Offset(OBFUSCATE("0xBC8FE4")), npcondestroy, old_npcondestroy);
